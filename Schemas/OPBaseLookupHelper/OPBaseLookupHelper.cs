...
{
    public abstract class OPBaseLookupHelper
    {
        ...
        protected OPBaseLookupHelper(UserConnection userConnection, string schemaName)
        {
    ...
    public class OPBodyTypeHelper : OPBaseLookupHelper
    {
        private readonly OPVehicleDataProvider _dataProvider;
        public OPBodyTypeHelper(UserConnection userConnection) : base(userConnection, "OPVehicleBodyType") { }
     
    }

    public class OPGenerationHelper : OPBaseLookupHelper
    {
        private readonly OPVehicleDataProvider _dataProvider;
        public OPGenerationHelper(UserConnection userConnection) : base(userConnection, "OPVehicleGeneration") { }
